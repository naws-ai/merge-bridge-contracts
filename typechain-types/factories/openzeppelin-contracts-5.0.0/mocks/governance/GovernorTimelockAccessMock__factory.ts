...
import type {
  ...
  GovernorTimelockAccessMockInterface,
} from "../../../../openzeppelin-contracts-5.0.0/mocks/governance/GovernorTimelockAccessMock";
...
export class GovernorTimelockAccessMock__factory {
  static readonly abi = _abi;
  static createInterface(): GovernorTimelockAccessMockInterface {
    return new Interface(_abi) as GovernorTimelockAccessMockInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as GovernorTimelockAccessMock;
  }
}
