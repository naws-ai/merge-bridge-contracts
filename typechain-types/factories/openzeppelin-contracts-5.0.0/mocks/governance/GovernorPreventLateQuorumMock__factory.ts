...
} from "../../../../openzeppelin-contracts-5.0.0/mocks/governance/GovernorPreventLateQuorumMock";
...
export class GovernorPreventLateQuorumMock__factory {
  ...
  static createInterface(): GovernorPreventLateQuorumMockInterface {
    return new Interface(_abi) as GovernorPreventLateQuorumMockInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as GovernorPreventLateQuorumMock;
  }
}
