...
export interface UUPSUnsupportedProxiableUUIDInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface UUPSUnsupportedProxiableUUID extends BaseContract {
  connect(runner?: ContractRunner | null): UUPSUnsupportedProxiableUUID;
  waitForDeployment(): Promise<this>;

  interface: UUPSUnsupportedProxiableUUIDInterface;
