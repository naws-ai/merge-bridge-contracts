...
export interface VotesTimestampMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "clock"
...
export interface VotesTimestampMock extends BaseContract {
  connect(runner?: ContractRunner | null): VotesTimestampMock;
  ...
  "delegate(address,address)": TypedContractMethod<
    [account: AddressLike, newDelegation: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "delegate(address,address)"
  ): TypedContractMethod<
    [account: AddressLike, newDelegation: AddressLike],
    [void],
    "nonpayable"
