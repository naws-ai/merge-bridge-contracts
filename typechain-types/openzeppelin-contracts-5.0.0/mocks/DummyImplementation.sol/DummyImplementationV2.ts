...
export interface DummyImplementationV2Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "get"
      | "initialize"
...
export interface DummyImplementationV2 extends BaseContract {
  connect(runner?: ContractRunner | null): DummyImplementationV2;
  ...
  migrate: TypedContractMethod<[newVal: BigNumberish], [void], "payable">;
  ...
  ): TypedContractMethod<[newVal: BigNumberish], [void], "payable">;
  getFunction(
