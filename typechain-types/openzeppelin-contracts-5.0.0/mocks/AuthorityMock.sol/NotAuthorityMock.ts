...
export interface NotAuthorityMockInterface extends Interface {
...
export interface NotAuthorityMock extends BaseContract {
  connect(runner?: ContractRunner | null): NotAuthorityMock;
  waitForDeployment(): Promise<this>;

  interface: NotAuthorityMockInterface;
