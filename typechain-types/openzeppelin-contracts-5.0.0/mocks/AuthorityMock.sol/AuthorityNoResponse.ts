...
export interface AuthorityNoResponseInterface extends Interface {
...
export interface AuthorityNoResponse extends BaseContract {
  connect(runner?: ContractRunner | null): AuthorityNoResponse;
  waitForDeployment(): Promise<this>;

  interface: AuthorityNoResponseInterface;
