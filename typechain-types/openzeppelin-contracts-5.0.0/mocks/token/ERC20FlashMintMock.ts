...
export interface ERC20FlashMintMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC20FlashMintMock extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20FlashMintMock;
  ...
  setFlashFeeReceiver: TypedContractMethod<
    [receiver: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "setFlashFeeReceiver"
