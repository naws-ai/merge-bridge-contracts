...
export interface ERC4626OffsetMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC4626OffsetMock extends BaseContract {
  connect(runner?: ContractRunner | null): ERC4626OffsetMock;
  waitForDeployment(): Promise<this>;

  interface: ERC4626OffsetMockInterface;
