...
export interface ERC4626LimitsMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC4626LimitsMock extends BaseContract {
  connect(runner?: ContractRunner | null): ERC4626LimitsMock;
  waitForDeployment(): Promise<this>;

  interface: ERC4626LimitsMockInterface;
