...
export interface ERC20VotesLegacyMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface ERC20VotesLegacyMock extends BaseContract {
  connect(runner?: ContractRunner | null): ERC20VotesLegacyMock;
  ...
  checkpoints: TypedContractMethod<
    ...
    [ERC20VotesLegacyMock.CheckpointStructOutput],
    "view"
  >;
