...
export interface ERC4626FeesMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC4626FeesMock extends BaseContract {
  connect(runner?: ContractRunner | null): ERC4626FeesMock;
  waitForDeployment(): Promise<this>;

  interface: ERC4626FeesMockInterface;
