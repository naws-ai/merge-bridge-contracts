...
export interface MigratableMockV1Interface extends Interface {
  getFunction(nameOrSignature: "initialize" | "x"): FunctionFragment;
...
export interface MigratableMockV1 extends BaseContract {
  connect(runner?: ContractRunner | null): MigratableMockV1;
