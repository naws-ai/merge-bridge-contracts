...
export interface GovernorWithParamsMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export namespace CountParamsEvent {
  export type InputTuple = [uintParam: BigNumberish, strParam: string];
  export type OutputTuple = [uintParam: bigint, strParam: string];
...
export interface GovernorWithParamsMock extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorWithParamsMock;
  ...
  getEvent(
    ...
    CountParamsEvent.InputTuple,
    CountParamsEvent.OutputTuple,
    CountParamsEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    "CountParams(uint256,string)": TypedContractEvent<
      CountParamsEvent.InputTuple,
      CountParamsEvent.OutputTuple,
      CountParamsEvent.OutputObject
    >;
    CountParams: TypedContractEvent<
      CountParamsEvent.InputTuple,
      CountParamsEvent.OutputTuple,
      CountParamsEvent.OutputObject
    >;
