...
export interface GovernorStorageMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface GovernorStorageMock extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorStorageMock;
  waitForDeployment(): Promise<this>;

  interface: GovernorStorageMockInterface;
