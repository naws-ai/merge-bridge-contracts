...
export interface GovernorTimelockAccessMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface GovernorTimelockAccessMock extends BaseContract {
  connect(runner?: ContractRunner | null): GovernorTimelockAccessMock;
  waitForDeployment(): Promise<this>;

  interface: GovernorTimelockAccessMockInterface;
  ...
  nonGovernanceFunction: TypedContractMethod<[], [void], "nonpayable">;
  ...
  getFunction(
    nameOrSignature: "nonGovernanceFunction"
