...
export interface AccessManagedERC20MintInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface AccessManagedERC20Mint extends BaseContract {
  connect(runner?: ContractRunner | null): AccessManagedERC20Mint;
  waitForDeployment(): Promise<this>;

  interface: AccessManagedERC20MintInterface;
