...
export interface ERC4626FeesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface ERC4626Fees extends BaseContract {
  connect(runner?: ContractRunner | null): ERC4626Fees;
  waitForDeployment(): Promise<this>;

  interface: ERC4626FeesInterface;
