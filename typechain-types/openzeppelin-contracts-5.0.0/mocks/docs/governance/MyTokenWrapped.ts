...
export interface MyTokenWrappedInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface MyTokenWrapped extends BaseContract {
  connect(runner?: ContractRunner | null): MyTokenWrapped;
  waitForDeployment(): Promise<this>;

  interface: MyTokenWrappedInterface;
