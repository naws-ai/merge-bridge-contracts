...
export interface MyTokenTimestampBasedInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface MyTokenTimestampBased extends BaseContract {
  connect(runner?: ContractRunner | null): MyTokenTimestampBased;
  waitForDeployment(): Promise<this>;

  interface: MyTokenTimestampBasedInterface;
